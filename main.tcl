...
#  May 16, 2020 12:10:00 AM JST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 630x473+470+399
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    $site_3_0 add command \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #d9d9d9 -command {{}} -font {} \
        -foreground $vTcl(pr,menufgcolor) -label NewCommand 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but44 \
    ...
    place $top.but45 \
        -in $top -x 0 -relx 0.365 -y 0 -rely 0.243 -width 165 -relwidth 0 \
        -height 142 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but46 \
